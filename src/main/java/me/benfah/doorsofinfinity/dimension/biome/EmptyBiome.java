...
public class EmptyBiome extends Biome
{
	...
	public EmptyBiome()
	{
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.NOPE, SurfaceBuilder.AIR_CONFIG)
				.precipitation(Biome.RainType.NONE).category(Category.NONE).depth(0.1F).scale(0.2F)
